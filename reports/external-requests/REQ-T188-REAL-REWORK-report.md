# REQ-T188-REAL-REWORK External Request Report

生成时间：2026-05-13T10:23:56
...
| Field | Value |
|-------|-------|
| REQUEST_ID | REQ-T188-REAL-REWORK |
| SOURCE_TYPE | local_inbox |
| SOURCE_REF | requests/inbox/REQ-T188-real-rework.md |
| TITLE | Real rework |
| REQUESTER | user |
...
- `real_execution_requested:真实返工`
- `real_rework_requested:真实返工`
- `prompt_injection:high:real_execution(真实返工)`
